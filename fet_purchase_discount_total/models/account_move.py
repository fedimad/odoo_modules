...
class AccountInvoice(models.Model):
    ...
    @api.depends(
        'line_ids.matched_debit_ids.debit_move_id.move_id.payment_'
        'id.is_matched',
        'line_ids.matched_debit_ids.debit_move_id.move_id.line_'
        'ids.amount_residual',
        'line_ids.matched_debit_ids.debit_move_id.move_id.line_ids.amount_'
        'residual_currency',
        'line_ids.matched_credit_ids.credit_move_id.move_id.payment_id.is_'
        'matched',
        'line_ids.matched_credit_ids.credit_move_id.move_id.line_ids.amount_'
        'residual',
        'line_ids.matched_credit_ids.credit_move_id.move_id.line_ids.amount_'
        'residual_currency',
        'line_ids.balance',
